// backend/scripts/validate-certification-fixes.test.ts
 ...
 * 
 * Uso:
 *   npx ts-node backend/scripts/validate-certification-fixes.test.ts
 * 
...
async function testBedrockFilter(): Promise<ValidationResult> {
  ...
  try {
    ...
    return {
      name: testName,
      passed: false,
      message: `Erro ao validar filtro: ${errorMessage}`,
    };
  }
}
...
async function testModelRegistryValidation(): Promise<ValidationResult> {
  ...
  try {
    ...
    return {
      name: testName,
      passed: false,
      message: `Erro ao validar ModelRegistry: ${errorMessage}`,
    };
  }
}
...
async function testNonBedrockModels(): Promise<ValidationResult> {
  ...
  try {
    ...
    return {
      name: testName,
      passed: false,
      message: `Erro ao verificar modelos não-Bedrock: ${errorMessage}`,
    };
  }
}
...
async function testCertificationQueueServiceIntegrity(): Promise<ValidationResult> {
  ...
  try {
    ...
    return {
      name: testName,
      passed: false,
      message: `Erro ao verificar arquivo: ${errorMessage}`,
    };
  }
}
...
async function testCleanupScriptExists(): Promise<ValidationResult> {
  ...
  try {
    ...
    return {
      name: testName,
      passed: false,
      message: `Erro ao verificar script: ${errorMessage}`,
    };
  }
}
