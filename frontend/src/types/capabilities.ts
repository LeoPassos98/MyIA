 ...
 *
 * Espelha os tipos definidos em backend/src/types/capabilities.ts
 */
...
/**
 * Resposta da API para um modelo específico
 */
...
/**
 * Resposta da API para todos os modelos
 */
